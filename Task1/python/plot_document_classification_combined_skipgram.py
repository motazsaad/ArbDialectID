...
union = FeatureUnion([
        ("w_v", TfidfVectorizer(sublinear_tf=False, max_df=0.5,analyzer = 'word', ngram_range=(1,2)
                                 )),
                       ("c_wb", TfidfVectorizer(sublinear_tf=False, max_df=0.5,analyzer = 'char_wb', ngram_range=(1,5)
                                 )),
...
#                                 )),
                       ("sk",TfidfVectorizer(sublinear_tf=False, max_df=0.5,tokenizer=make_skip_tokenize(n=2, k=2)))
                       ]
#,
#transformer_weights={
#            'w_v': 0.2,
